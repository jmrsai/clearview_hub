...
class _$AchievementImpl implements _Achievement {
  ...
  @override
  String toString() {
    return 'Achievement(id: $id, title: $title, description: $description, icon: $icon, isUnlocked: $isUnlocked, unlockedAt: $unlockedAt, progress: $progress, target: $target)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, title, description, icon,
      isUnlocked, unlockedAt, progress, target);
...
abstract class _Achievement implements Achievement {
  const factory _Achievement(
      ...
      final DateTime? unlockedAt,
      final int progress,
      final int target}) = _$AchievementImpl;
